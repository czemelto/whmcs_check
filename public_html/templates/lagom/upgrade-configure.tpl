{if isset($RSThemes['pages']['upgrade-configure'])}
    {include file=$RSThemes['pages']['upgrade-configure']['fullPath']}
{else} 	
	<div class="upgrade">
		{if $errorMessage}
			<div class="message message-danger message-lg message-no-data">
				...
				<h2 class="message-text">{lang key="genericerror.title"}</h2>
				<h6 class="text-center text-light">{$errorMessage}</h6>
