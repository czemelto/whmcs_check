...
$pdf->Image(ROOTDIR . '/assets/img/' . $logoFilename, 17.5,10,'','15');
...
$pdf->Cell(0,20,$invoiceprefix.$invoicenum,0,1,'L','1');
...
$tblhtml = '
    <table width="100%" bgcolor="#fff" cellspacing="0" cellpadding="7" border="0" style="color: #45474c;">
        <tr>
            <td width="25%" style="font-size: 8px; line-height: 16px; color: #a1a5b3; font-weight: bold">'.$_LANG["invoicesdatecreated"].'<br/>
            '.$_LANG["invoicesdatedue"].'
            '.($status=="Paid" ? "<br/>PAID" : "").'
            </td>
            <td width="44.2%" style="font-size: 9px; line-height: 16px;">'.$datecreated.'<br/>
            '.$duedate.'
            ...
            <td width="30%" style="font-size: 9px; line-height: 16px;"><span style="font-size: 8px; line-height: 16px; color: #a1a5b3; font-weight: bold">'.$_LANG['invoicesinvoicedto'].'</span><br/>
                '.($clientsdetails["companyname"] ? "<strong>".$clientsdetails["companyname"]."</strong>" : "").'
