<div class="main-content col-md-12 ">
    ...
    {if !$registrationDisabled}
        <div class="logincontainer register" id="registration">
            <div class="logincontainer-body social-wide">
                {if $RSThemes['pages'][$templatefile]['config']['showLogo'] == '1'}
                    {include file="$template/includes/pageheader.tpl" title=$LANG.register textcenter=true}
                {/if}
                {if $errormessage}
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" name="firstname" id="inputFirstName" maxlength="50" class="form-control" placeholder="" value="{$clientfirstname}" {if !in_array('firstname', $optionalFields)}required{/if} autofocus>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" name="lastname" id="inputLastName" maxlength="100" class="form-control" placeholder="" value="{$clientlastname}" {if !in_array('lastname', $optionalFields)}required{/if}>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group ">
