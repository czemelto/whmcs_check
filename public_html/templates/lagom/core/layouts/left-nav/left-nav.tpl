    ...
    <div class="app-nav hidden-print">
        <section id="header">
            <div class="container">
                ...
                {elseif $RSThemes.styles.vars.leftMenuOnLightBg}
                    {if $RSThemes.logoSquare}
                        <a href="{if $lagom_logo_url}{$lagom_logo_url}{else}{$WEB_ROOT}/index.php{/if}" class="logo hidden-sm hidden-xs"><img src="{$WEB_ROOT}{$RSThemes.logoSquare}" alt="{$companyname}"/></a>
                        {if $RSThemes.styles.vars.topMenuOnDarkBg && $RSThemes.logo_inverse}
                            <a href="{if $lagom_logo_url}{$lagom_logo_url}{else}{$WEB_ROOT}/index.php{/if}" class="logo visible-xs visible-sm"><img src="{$WEB_ROOT}{$RSThemes.logo_inverse}" alt="{$companyname}"/></a>
                        {else}
                            <a href="{if $lagom_logo_url}{$lagom_logo_url}{else}{$WEB_ROOT}/index.php{/if}" class="logo visible-xs visible-sm"><img src="{$WEB_ROOT}{$RSThemes.logo}" alt="{$companyname}"/></a>    
                        {/if}
                ...
                {else}
                    {if $RSThemes.logoSquareInverse}
                        <a href="{if $lagom_logo_url}{$lagom_logo_url}{else}{$WEB_ROOT}/index.php{/if}" class="logo hidden-sm hidden-xs"><img src="{$WEB_ROOT}{$RSThemes.logoSquareInverse}" alt="{$companyname}"/></a>
                        {if $RSThemes.styles.vars.topMenuOnDarkBg && $RSThemes.logo_inverse}
                            <a href="{if $lagom_logo_url}{$lagom_logo_url}{else}{$WEB_ROOT}/index.php{/if}" class="logo visible-xs visible-sm"><img src="{$WEB_ROOT}{$RSThemes.logo_inverse}" alt="{$companyname}"/></a>
                        {else}
                            <a href="{if $lagom_logo_url}{$lagom_logo_url}{else}{$WEB_ROOT}/index.php{/if}" class="logo visible-xs visible-sm"><img src="{$WEB_ROOT}{$RSThemes.logo}" alt="{$companyname}"/></a>    
                    ...
                    {elseif $RSThemes.logoSquare}
                        <a href="{if $lagom_logo_url}{$lagom_logo_url}{else}{$WEB_ROOT}/index.php{/if}" class="logo"><img src="{$WEB_ROOT}{$RSThemes.logoSquare}" alt="{$companyname}"/></a>
                        {if $RSThemes.styles.vars.topMenuOnDarkBg && $RSThemes.logo_inverse}
                            <a href="{if $lagom_logo_url}{$lagom_logo_url}{else}{$WEB_ROOT}/index.php{/if}" class="logo visible-xs visible-sm"><img src="{$WEB_ROOT}{$RSThemes.logo_inverse}" alt="{$companyname}"/></a>
                        {else}
                            <a href="{if $lagom_logo_url}{$lagom_logo_url}{else}{$WEB_ROOT}/index.php{/if}" class="logo visible-xs visible-sm"><img src="{$WEB_ROOT}{$RSThemes.logo}" alt="{$companyname}"/></a>    
                    ...
                    {elseif $RSThemes.logo_inverse}
                        <a href="{if $lagom_logo_url}{$lagom_logo_url}{else}{$WEB_ROOT}/index.php{/if}" class="logo hidden-sm hidden-xs"><img src="{$WEB_ROOT}{$RSThemes.logo_inverse}" alt="{$companyname}"/></a>
                        {if $RSThemes.styles.vars.topMenuOnDarkBg && $RSThemes.logo_inverse}
                            <a href="{if $lagom_logo_url}{$lagom_logo_url}{else}{$WEB_ROOT}/index.php{/if}" class="logo visible-xs visible-sm"><img src="{$WEB_ROOT}{$RSThemes.logo_inverse}" alt="{$companyname}"/></a>
                        {else}
                            <a href="{if $lagom_logo_url}{$lagom_logo_url}{else}{$WEB_ROOT}/index.php{/if}" class="logo visible-xs visible-sm"><img src="{$WEB_ROOT}{$RSThemes.logo}" alt="{$companyname}"/></a>    
                                ...
                                {foreach $clientAlerts as $alert}
                                    <li>
                                        <a href="{$alert->getLink()}">
                                            <i class="ls ls-{if $alert->getSeverity() == 'danger'}exclamation-circle text-danger{elseif $alert->getSeverity() == 'warning'}exclamation-circle text-warning{elseif $alert->getSeverity() == 'info'}info-circle text-info {else}info-circle{/if}"></i>
    ...
    <div class="main-top">
        <div class="container">
            <ul class="top-nav">
                {if $adminMasqueradingAsClient || $adminLoggedIn}
                    <li>
                        <a href="{$WEB_ROOT}/logout.php?returntoadmin=1" class="btn " data-toggle="tooltip" data-placement="bottom" title="{if $adminMasqueradingAsClient}{$LANG.adminmasqueradingasclient} {$LANG.logoutandreturntoadminarea}{else}{$LANG.adminloggedin} {$LANG.returntoadminarea}{/if}">
                            <i class="lm lm-arrow-fat-right"></i>
                        </a>
                    </li>
                {/if}
