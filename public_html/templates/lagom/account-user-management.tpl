{if isset($RSThemes['pages']['account-user-management'])}
    {include file=$RSThemes['pages']['account-user-management']['fullPath']}
{else}
    {include file="$template/includes/flashmessage.tpl"}
    <div class="section">
        <div class="section-header d-flex align-center m-b-24">
            <h3 class="m-b-0">{lang key="userManagement.usersFound" count=$users->count()}</h3>
            <a href="#inviteNewUser" class="btn btn-primary m-l-a" data-toggle="modal">{lang key="userManagement.inviteNewUser"}</a>
        </div>
                        ...
                        {foreach $users as $user}
                            <li class="user-list-item">
                                ...
                                <span class="user-list-item-info">
                                    ...
                                    <span class="user-list-item-email text-small text-light">{$user->email}</span>
                                </span>
                                <span class="user-list-item-date">
                                    <span class="text-small text-light">{lang key="userManagement.lastLogin"}:</span>
                                    <span>{if $user->pivot->hasLastLogin()}
    ...
    <div class="section">
        <div class="sction-header">
            <h3>{lang key="userManagement.pendingInvites"}</h3>
        </div>
        <div class="section-body">
            <div class="panel panel-users">
                <div class="panel-body">
