{if file_exists("templates/$template/includes/overwrites/sidebar-promo.tpl")}
    {include file="{$template}/includes/overwrites/sidebar-promo.tpl"}
{else}
    ...
    {if $templatefile == 'clientareaproducts'}
        ...
        {elseif $show_promo_prods}
            {include file="$template/includes/promo-slider.tpl" setting="product-list" class="promo-slider-xs"}
        {/if}
    {/if}
    {if $templatefile == 'clientareaproductdetails'}
        ...
        {elseif $show_promo_proddet}
            {include file="$template/includes/promo-slider.tpl" setting="product-details" class="promo-slider-xs"}
        {/if}
    {/if}
{/if}