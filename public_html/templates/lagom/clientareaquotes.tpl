{if isset($RSThemes.pages.clientareaquotes)}
    {include file=$RSThemes['pages']['clientareaquotes']['fullPath']}
{else}
    {if $quotes}
                    ...
                    <div class="dropdown view-filter-btns">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            {foreach key=num item=status from=$RSQuotesStatuses}
                                    <li><a href="#"><span data-value="{$status.stage}">{$status.stage}</span></a></li>
                            {/foreach}
                        </ul>
                    </div>
                </div>  
    ...
    {else}
        <div class="message message-no-data">
            ...
            <h6 class="message-text">{$LANG.noquotes}</h6>
