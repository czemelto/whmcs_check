{if isset($RSThemes['pages']['account-paymentmethods'])}
    {include file=$RSThemes['pages']['account-paymentmethods']['fullPath']}
{else}
    {if $createSuccess}
        ...
        <div class="section-body">
            ...
            {else}
                <div class="message message-sm message-no-data">
                    ...
                    <h6 class="message-text">{$LANG.paymentMethods.noPaymentMethodsCreated}</h6>
