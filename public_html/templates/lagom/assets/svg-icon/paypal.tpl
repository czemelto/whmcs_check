<svg class="svg-icon" version="1.1" class="svg-paypal" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="72px" height="19px" viewBox="0 0 72 19" style="enable-background:new 0 0 72 19;" xml:space="preserve">
