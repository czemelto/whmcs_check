<svg class="svg-icon{if $onDark} svg-icon-on-dark{/if} svg-stripe" version="1.1" class="svg-stripe"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="53px" height="22px" viewBox="0 0 53 22" style="enable-background:new 0 0 53 22;" xml:space="preserve">
