{if count($existingCards) > 0}
    <div class="panel-nav">
        <ul class="nav nav-tabs">
            <li {if $cardOnFile && $ccinfo neq "new"}class="active"{/if}>
                <a href="#existingCardInfo" data-simple-radio-tab data-toggle="tab" aria-expanded="true">                                    
                    {$LANG.creditcarduseexisting}
                </a>
            </li>
            <li {if $ccinfo eq "new" || !$cardOnFile}class="active"{/if}>
                <a href="#newCardInfoTab" data-simple-radio-tab data-toggle="tab" aria-expanded="false">
                    <div class="hidden">
