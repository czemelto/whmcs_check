{if isset($RSThemes['pages']['account-paymentmethods-manage'])}
    {include file=$RSThemes['pages']['account-paymentmethods-manage']['fullPath']}
{else}
                    ...
                    <div class="panel-body">
                        ...
                        <div class="fieldgroup-bankaccount{if $remoteUpdate || ($editMode && $payMethod->isCreditCard()) || ($paymentMethodType != 'bankacct' && !$editMode)} hidden{/if}">
                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        <label for="inputBankAcctHolderName" class="control-label">{$LANG.paymentMethodsManage.accountHolderName}</label>
