{if isset($RSThemes.pages.clientareaproductdetails)}
    {include file=$RSThemes['pages']['clientareaproductdetails']['fullPath']}
{else}  
            ...
            {else}
                ...
                <div class="product-details clearfix">
                    <div class="row row-eq-height row-eq-height-sm">
                                ...
                                <div class="product-content">
                                    <div class="product-image">
                                        {if $type eq "hostingaccount" || $type == "reselleraccount"}
                                            {include file="$template//assets/svg-icon/addon.tpl" onDark="true"}
                                    ...
                                    <div class="product-status">{$LANG.clientareastatus}:
                                        <span class="label label-{$rawstatus|strtolower}">{$status}</span>
                                    </div>
                                </div>    
                                {if $domain}  
                        ...
                        <div class="col-sm-6">
                            {if $lastupdate}
                                <div class="panel panel-default panel-form" id="cPanelUsagePanel">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-5 col-sm-offset-1 col-xs-6">
                                                <div class="usage-stats">
                                                    ...
                                                    <input type="text" value="{$diskpercent|substr:0:-1}" class="usage-dial" data-bgColor="{if $RSThemes.styles.vars.colorGray}{$RSThemes.styles.vars.colorGray}{else}#e6e8ec{/if}" data-fgColor="{if $RSThemes.styles.vars.colorPrimary}{$RSThemes.styles.vars.colorPrimary}{else}#0c70de{/if}" data-angleOffset="-125" data-angleArc="250" data-min="0" data-max="{if substr($diskpercent, 0, -1) > 100}{$diskpercent|substr:0:-1}{else}100{/if}" data-readOnly="true" data-width="104" data-thickness=.3 data-height="80" />                          
                                            ...
                                            <div class="col-sm-5 col-xs-6">
                                                <div class="usage-stats">
                                                    ...
                                                    <input type="text" value="{$bwpercent|substr:0:-1}" class="usage-dial" data-bgColor="{if $RSThemes.styles.vars.colorGray}{$RSThemes.styles.vars.colorGray}{else}#e6e8ec{/if}" data-fgColor="{if $RSThemes.styles.vars.colorPrimary}{$RSThemes.styles.vars.colorPrimary}{else}#0c70de{/if}" data-angleOffset="-125" data-angleArc="250" data-min="0" data-max="{if substr($bwpercent, 0, -1) > 100}{$bwpercent|substr:0:-1}{else}100{/if}" data-readOnly="true" data-width="104" data-thickness=.3 data-height="80" />
                ...
                <div class="panel panel-default panel-product-details">
                    ...
                    <div class="module-client-area module-{$module}">
                        {$moduleclientarea}
                    </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-nav">
                            <ul class="nav nav-tabs">							
                                ...
                                {/if}
                                {if $domain}
                                    <li {if !$customModuleInfo && !$lastupdate}class="active{/if}">
                                        <a href="#domain" data-toggle="tab"><i class="ls ls-location"></i> {if $type eq "server"}{$LANG.sslserverinfo}{elseif ($type eq "hostingaccount" || $type eq "reselleraccount") && $serverdata}{$LANG.hostingInfo}{else}{$LANG.clientareahostingdomain}{/if}</a>
                                    </li>
                                {/if}
                                {if $configurableoptions}
                                    <li {if !$domain && !$moduleclientarea} class="active"{/if}>
                                        <a href="#configoptions" data-toggle="tab"><i class="ls ls-configure"></i> {$LANG.orderconfigpackage}</a>
                                    </li>
                                {/if}
                                {if $metricStats}
                                ...
                                {if $customfields}
                                    <li {if !$domain && !$moduleclientarea && !$metricStats && !$configurableoptions} class="active"{/if}>
                                        <a href="#additionalinfo" data-toggle="tab"><i class="ls ls-info-circle"></i> {$LANG.additionalInfo}</a>
                                    </li>
                                {/if}
                            </ul>
                        </div>               
                        <div class="tab-content">							
                            {if $customModuleInfo || $lastupdate}
                            <div class="tab-pane{if $customModuleInfo || $lastupdate} active{/if} billingOverview" id="billingInfo">
                                <div class="row row-eq-height row-eq-height-sm ">				
                                    {if $firstpaymentamount neq $recurringamount}
                                    ...
                                    {else}
                                        {if $domain}
                                            <li>
                                                ...
                                                <span class="list-info-text">{$domain}<span class="m-l-8"><a href="http://{$domain}" target="_blank" class="btn btn-default btn-xs" >{$LANG.visitwebsite}</a></span></span>
                                            </li>
                                            {if $sslStatus}
