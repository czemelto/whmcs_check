{if isset($RSThemes.pages.supportticketslist)}
    {include file=$RSThemes['pages']['supportticketslist']['fullPath']}
{else}    
    {if $tickets}
    ...
    {else}
        <div class="message message-no-data">
            ...
            <h6 class="message-text">{$rslang->trans('nodata.no_recent_tickets')}</h6>
